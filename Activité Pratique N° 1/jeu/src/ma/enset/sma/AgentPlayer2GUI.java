...
public class AgentPlayer2GUI extends Application {
    private AgentPlayer2 agentPlayer2; //réf de Agent client
    ...
    public void start(Stage primaryStage) throws Exception {
        startContainer();
        primaryStage.setTitle("Agent Player 2");
        ...
        buttonSend.setOnAction(event -> {
            ...
            /**Send**/
            agentPlayer2.onGuiEvent(guiEvent); //envoyer cette Event
        });
    }
    ...
    private void startContainer() throws Exception {
        ...
        AgentController agentClient = container.createNewAgent("player2", "ma.enset.sma.AgentPlayer2", new Object[]{this,"player2"});
        agentClient.start();
    }

    public void setAgentClient(AgentPlayer2 agentPlayer2) {
        this.agentPlayer2 = agentPlayer2;
    }
