...
public class AgentPlayer2 extends GuiAgent { // Agent a une GI
    private AgentPlayer2GUI agentPlayer2GUI; //point de liaison (réf de Graphique Interface): User <-> Graphique Interface
    ...
    protected void setup() {
        ...
        //=> initialiser
        agentPlayer2GUI = (AgentPlayer2GUI) getArguments()[0];
        agentPlayer2GUI.setAgentClient(this);
        addBehaviour(new CyclicBehaviour() {
            ...
            public void action() {
                ...
                ACLMessage receiveMsg = blockingReceive(); // receive()
                    if (receiveMsg != null) {
                        agentPlayer2GUI.showMessage("<< "+receiveMsg.getContent());
