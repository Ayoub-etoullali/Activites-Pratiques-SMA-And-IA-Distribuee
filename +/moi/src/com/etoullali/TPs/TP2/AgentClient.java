...
public class AgentClient extends GuiAgent { // Agent a une GI
    private AgentClientGUI clientGUI; //point de liaison (réf de Graphique Interface): User <-> Graphique Interface
        ...
        addBehaviour(new CyclicBehaviour() {
            ...
            public void action() {
                ACLMessage receiveMsg = blockingReceive(); // receive()
                    if (receiveMsg != null) {
                        clientGUI.showMessage("<< "+receiveMsg.getContent());
