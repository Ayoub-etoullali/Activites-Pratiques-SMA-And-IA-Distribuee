...
import com.etoullali.TPs.TP2.AgentClient;
...
public class AgentClientGUI extends Application {
    private AgentClient agentClient; //réf de Agent client
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        buttonSend.setOnAction(event -> {
            ...
            agentClient.onGuiEvent(guiEvent); //envoyer cette Event
        });
    }
    ...
    private void startContainer() throws Exception {
        ...
        AgentController agentClient = container.createNewAgent("client", "com.etoullali.TPs.TP2.AgentClient", new Object[]{this});
        agentClient.start();
    }
